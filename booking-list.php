...
// $url = "https://api.test.hotelbeds.com/booking-api/1.0/bookings"; // Example endpoint, replace with actual endpoint
$url = "https://api.test.hotelbeds.com/hotel-api/1.0/bookings"; // Example endpoint, replace with actual endpoint
$headers = array(
